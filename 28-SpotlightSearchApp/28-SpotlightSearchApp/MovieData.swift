...
class MovieData {
    var movieFile: [Movie] = [
        Movie(imageName: "django", movieTitle: "The Django", movieType: "Drama, Western", movieDescription: "Django is a freed slave who assists a German bounty hunter. Im return for his aid, the Bounty Hunter will help Django get revernge on the cruel Plantation owner in Mississippi, who has kidnapped his wife.", movieDirector: "Quentin Tarantino", movieRating: "8.4", movieStars: "Jamie Foxx, Christoph Walth, Leonardo DiCaprio"),
